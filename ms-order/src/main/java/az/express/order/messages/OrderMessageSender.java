...
import az.express.order.messages.binder.OrderCreateStateOut;
...
@Slf4j
@Component
@EnableBinding(OrderCreateStateOut.class)
public class OrderMessageSender<T> {

    private final MessageChannel output;
    private final ObjectMapper objectMapper;

    public OrderMessageSender(@Qualifier("orderCreateStateOutput") MessageChannel output, ObjectMapper objectMapper) {
        this.output = output;
